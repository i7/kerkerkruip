...
"List of special verbs"	"You may find the 3-page Beginner's Guide more convenient, but here is a list of some of the special verbs of Kerkerkruip. (Verbs having to do with specific objects or skills will not be given: you can look these up through examining the object, or the 'status' command.)[paragraph break]Actions that [italic type]give information[roman type]: 'status', 'map', 'remember' ('r'), 'sense', 'trophies'.[paragraph break]Actions [italic type]used in combat[roman type] at the [italic type]Act>[roman type] prompt: 'attack <person>' ('a'), 'concentrate' ('c').[paragraph break]Actions [italic type]used in combat[roman type] at the [italic type]React>[roman type] prompt: 'parry' ('p'), 'dodge' ('do'), 'block', 'expose'.[paragraph break]Actions that [italic type]move the player[roman type]: 'retreat', 'go to <room>'.[paragraph break]Actions that [italic type]work in specific locations[roman type]: 'sacrifice'.[paragraph break]Actions that [italic type]allow you to use objects[roman type]: 'ready <weapon>', 'unready <weapon>', 'throw <grenade>', 'throw <grenade> <direction>', 'read <scroll>', 'wear <clothing>', 'take off <clothing>'.[paragraph break]Actions that [italic type]bring you to this or another menu[roman type]: 'help', 'achievements'.[paragraph break]Actions that [italic type]change the cosmetics of the game[roman type]: 'panels'."
