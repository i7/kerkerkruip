...
"Basic combat reactions"	"When someone attacks you in Kerkerkruip, you will get a special 'React>' prompt. There are two basic moves you can use at this prompt: 'dodge' and 'parry', which can be abbreviated to 'do' and 'p' respectively. Both of these moves will make you harder to hit, only parrying is influenced by the weapon you are wielding. Common sense will generally tell you which of the two is the best. (For instance, don't try to parry a huge warhammer if you are carrying a dagger.) You can read more about defensive strategy in the Advanced Concepts."
...
"Offensive and defensive flow"	"[paragraph break]In addition to concentration and tension, two other numbers affect every attack in Kerkerkruip. These are 'offensive flow' and 'defensive flow'. Every point of offensive flow increases the chance of an attack hitting by 1 and increases attack damage by 1. Likewise, defensive flow reduces both.[paragraph break]Offensive flow is increased by successfully parrying or rolling into combat. Defensive flow is increased by successfully dodging. The sum of offensive and defensive flow can never be greater than 3. Both are reset to zero when attacking unsuccessfully or when getting damaged by an attack."
